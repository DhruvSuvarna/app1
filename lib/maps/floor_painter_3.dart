...
class FloorMapPainter3 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final List<Map<String, dynamic>> rooms = [
      {"number": "301", "x": 495, "y": 100},
      {"number": "302", "x": 615, "y": 250},
      {"number": "303", "x": 615, "y": 450},
      {"number": "304", "x": 615, "y": 650},
      {"number": "305", "x": 615, "y": 850},
      {"number": "306", "x": 495, "y": 1000},
      {"number": "307", "x": 200, "y": 1000},
      {"number": "308", "x": 80, "y": 850},
      {"number": "309", "x": 80, "y": 650},
      {"number": "310", "x": 80, "y": 450},
      {"number": "311", "x": 80, "y": 250},
      {"number": "312", "x": 200, "y": 100},
    ];

    final Map<String, Offset> nodePositions = {
      "301": Offset(545 * scaleX, 230 * scaleY),
      "302": Offset(590 * scaleX, 300 * scaleY),
      "303": Offset(590 * scaleX, 500 * scaleY),
      "304": Offset(590 * scaleX, 700 * scaleY),
      "305": Offset(590 * scaleX, 900 * scaleY),
      "306": Offset(545 * scaleX, 970 * scaleY),
      "307": Offset(250 * scaleX, 970 * scaleY),
      "308": Offset(205 * scaleX, 900 * scaleY),
      "309": Offset(205 * scaleX, 700 * scaleY),
      "310": Offset(205 * scaleX, 500 * scaleY),
      "311": Offset(205 * scaleX, 300 * scaleY),
      "312": Offset(250 * scaleX, 230 * scaleY),
      "S3a": Offset(400 * scaleX, 230 * scaleY),
      "S3b": Offset(400 * scaleX, 970 * scaleY),
    };
    ...
    final Paint roomPaint = Paint()
      ..color = Color.fromARGB(255, 239, 195, 151)
      ..style = PaintingStyle.fill;
  ...
  @override
  bool shouldRepaint(FloorMapPainter3 oldDelegate) => false;
}
