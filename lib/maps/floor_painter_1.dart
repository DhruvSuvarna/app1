...
class FloorMapPainter1 extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final List<Map<String, dynamic>> rooms = [
      {"number": "101", "x": 495, "y": 100},
      {"number": "102", "x": 615, "y": 250},
      {"number": "103", "x": 615, "y": 450},
      {"number": "104", "x": 615, "y": 650},
      {"number": "105", "x": 615, "y": 850},
      {"number": "106", "x": 495, "y": 1000},
      {"number": "107", "x": 200, "y": 1000},
      {"number": "108", "x": 80, "y": 850},
      {"number": "109", "x": 80, "y": 650},
      {"number": "110", "x": 80, "y": 450},
      {"number": "111", "x": 80, "y": 250},
      {"number": "112", "x": 200, "y": 100},
    ];

    final Map<String, Offset> nodePositions = {
      "101": Offset(545 * scaleX, 230 * scaleY),
      "102": Offset(590 * scaleX, 300 * scaleY),
      "103": Offset(590 * scaleX, 500 * scaleY),
      "104": Offset(590 * scaleX, 700 * scaleY),
      "105": Offset(590 * scaleX, 900 * scaleY),
      "106": Offset(545 * scaleX, 970 * scaleY),
      "107": Offset(250 * scaleX, 970 * scaleY),
      "108": Offset(205 * scaleX, 900 * scaleY),
      "109": Offset(205 * scaleX, 700 * scaleY),
      "110": Offset(205 * scaleX, 500 * scaleY),
      "111": Offset(205 * scaleX, 300 * scaleY),
      "112": Offset(250 * scaleX, 230 * scaleY),
      "S1a": Offset(400 * scaleX, 230 * scaleY),
      "S1b": Offset(400 * scaleX, 970 * scaleY),
    };
  ...
  @override
  bool shouldRepaint(FloorMapPainter1 oldDelegate) => false;
}
